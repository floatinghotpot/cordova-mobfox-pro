...
@protocol MobFoxEventDelegate <NSObject>
@required
-(UIView*) getView;
...
@interface MobFoxAds : NSObject<MobFoxBannerViewDelegate, MobFoxVideoInterstitialViewControllerDelegate>

- (MobFoxAds*) init:(id<MobFoxEventDelegate>) theDelegate;
